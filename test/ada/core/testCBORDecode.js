...
describe('testCBORDecode', () => {
  ...
  it('Should reject a transaction with inputs > 6', (done) => {
    ...
    getLedger()
      ...
      .catch((error) => {
        // 5905: < 1 tx output
        expect(error).to.have.string('5905');
        done()
      });
  });
  
  it('Should reject a transaction with outputs > 6', (done) => {
    ...
    getLedger()
      ...
      .catch((error) => {
        // 5906: < 1 tx output
        expect(error).to.have.string('5906');
        done()
      });
  });
